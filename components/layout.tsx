...
export default function Layout({ children, title = "Dictionary" }: Props) {
  return (
    <>
      <Head>
        <title>
          {title !== "Dictionary" ? `${title} • Dictionary` : title}
        </title>
        <meta charSet="utf-8" />
          ...
          <div className="mx-auto flex flex-col items-center space-y-6 px-4 py-6 md:px-0 lg:flex-row lg:justify-between lg:space-y-0">
            ...
            <div className="flex items-center space-x-6">
              ...
              <a
                ...
                target="_blink"
                className="transition-colors duration-300 after:hidden "
              >
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
